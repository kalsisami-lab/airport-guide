...
import { HEL_FINNAIR_HYBRID_LOUNGES } from './oneworld';

// Lounges accessible via Priority Pass, LoungeKey, DragonPass, or Amex Platinum.
// Hybrid lounges that also accept alliance status are imported from oneworld.ts
// to avoid duplication.

export const CARD_ACCESS_LOUNGES: Readonly<Record<string, StaticLounge[]>> = {
  HEL: [
