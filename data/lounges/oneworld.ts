...
const HEL_FINNAIR_LOUNGES: StaticLounge[] = [
  {
    ...
    allowedAirlines: ['AY'],
    allianceAccess: 'carrier-specific',
...
export const ONEWORLD_LOUNGES: Readonly<Record<string, StaticLounge[]>> = {
  ...
  FRA: [
    {
      ...
      networks: ['oneworld'],
      allowedAlliances: ['oneworld'],
      allowedAirlines: ['JL', 'AA', 'BA', 'CX', 'QF', 'QR', 'MH', 'AY', 'IB'],
      allianceAccess: 'all-alliance',
    ...
    },
    {
      ...
      networks: ['oneworld'],
      allowedAlliances: ['oneworld'],
      allowedAirlines: ['IB', 'AA', 'BA', 'CX', 'QF', 'QR', 'JL', 'AY', 'MH'],
      allianceAccess: 'all-alliance',
    ...
    },
    {
      ...
      networks: ['oneworld'],
      allowedAlliances: ['oneworld'],
      allowedAirlines: ['QR', 'AA', 'BA', 'CX', 'QF', 'JL', 'AY', 'IB', 'MH'],
      allianceAccess: 'all-alliance',
  ...
  LHR: [
    ...
    },
    {
      ...
      networks: ['oneworld'],
      allowedAlliances: ['oneworld'],
      allowedAirlines: ['BA', 'IB', 'AA', 'CX', 'QF', 'JL', 'QR', 'AY', 'MH', 'RJ'],
      allianceAccess: 'all-alliance',
      openingHours: 'Daily 05:00–22:00',
    ...
    },
    {
      ...
      networks: ['oneworld'],
      allowedAlliances: ['oneworld'],
      allowedAirlines: ['BA', 'AA', 'CX', 'QF', 'MH', 'JL', 'QR', 'AY', 'IB', 'RJ'],
      allianceAccess: 'all-alliance',
      openingHours: 'Daily 05:00–22:00',
  ...
  MAD: [
    {
      ...
      networks: ['oneworld'],
      allowedAlliances: ['oneworld'],
      allowedAirlines: ['IB', 'BA', 'AA', 'QR', 'JL', 'CX', 'AY'],
      allianceAccess: 'all-alliance',
  ...
  DOH: [
    {
      ...
      networks: ['oneworld'],
      allowedAlliances: ['oneworld'],
      allowedAirlines: ['QR', 'AA', 'BA', 'JL', 'CX', 'AY', 'QF', 'IB', 'MH', 'RJ'],
      allianceAccess: 'all-alliance',
  ...
  SIN: [
    {
      ...
      networks: ['oneworld'],
      allowedAlliances: ['oneworld'],
      allowedAirlines: ['QF', 'AA', 'BA', 'AY', 'CX', 'JL', 'QR', 'MH', 'IB'],
      allianceAccess: 'all-alliance',
  ...
  HKG: [
    ...
    },
    {
      ...
      networks: ['oneworld'],
      allowedAlliances: ['oneworld'],
      allowedAirlines: ['CX', 'KA', 'AA', 'BA', 'JL', 'QF', 'MH', 'QR', 'AY', 'IB'],
      allianceAccess: 'all-alliance',
      openingHours: '24 hours',
    ...
    },
    {
      ...
      networks: ['oneworld'],
      allowedAlliances: ['oneworld'],
      allowedAirlines: ['CX', 'KA', 'AA', 'BA', 'JL', 'QF', 'QR', 'AY', 'IB', 'MH'],
      allianceAccess: 'all-alliance',
      openingHours: '24 hours',
  ...
  NRT: [
    ...
    },
    {
      ...
      networks: ['oneworld'],
      allowedAlliances: ['oneworld'],
      allowedAirlines: ['JL', 'AA', 'BA', 'CX', 'QF', 'MH', 'AY', 'QR', 'IB'],
      allianceAccess: 'all-alliance',
  ...
  KUL: [
    {
      ...
      networks: ['oneworld'],
      allowedAlliances: ['oneworld'],
      allowedAirlines: ['MH', 'AA', 'BA', 'CX', 'QF', 'JL', 'AY', 'QR', 'IB'],
      allianceAccess: 'all-alliance',
      openingHours: '24 hours',
  ...
  SYD: [
    ...
    },
    {
      ...
      networks: ['oneworld'],
      allowedAlliances: ['oneworld'],
      allowedAirlines: ['QF', 'AA', 'BA', 'CX', 'JL', 'MH', 'AY', 'QR', 'IB'],
      allianceAccess: 'all-alliance',
  ...
  JFK: [
    {
      ...
      networks: ['oneworld'],
      allowedAlliances: ['oneworld'],
      allowedAirlines: ['AA', 'BA', 'QR', 'JL', 'CX', 'AY', 'QF', 'IB', 'MH'],
      allianceAccess: 'all-alliance',
      openingHours: 'Daily 05:30–23:00',
  ...
  LAX: [
    {
      ...
      networks: ['oneworld'],
      allowedAlliances: ['oneworld'],
      allowedAirlines: ['AA', 'BA', 'QR', 'JL', 'CX', 'QF', 'AY', 'IB', 'MH'],
      allianceAccess: 'all-alliance',
      openingHours: 'Daily 05:00–22:00',
  ...
  ORD: [
    {
      ...
      networks: ['oneworld'],
      allowedAlliances: ['oneworld'],
      allowedAirlines: ['AA', 'BA', 'IB', 'JL', 'CX', 'QR', 'AY', 'QF', 'MH'],
      allianceAccess: 'all-alliance',
      openingHours: 'Daily 05:30–22:00',
      amenities: ['À la carte dining', 'Premium bar', 'Shower suites', 'WiFi'],
    ...
    },
    {
      ...
      networks: ['oneworld'],
      allowedAlliances: ['oneworld'],
      allowedAirlines: ['AA', 'BA', 'IB', 'JL', 'QR', 'AY', 'CX', 'QF', 'MH'],
      allianceAccess: 'all-alliance',
      openingHours: 'Daily 05:30–22:00',
      amenities: ['Hot buffet', 'Bar', 'Shower rooms', 'WiFi', 'Work desks'],
  ...
  GRU: [
    {
      ...
      networks: ['oneworld'],
      allowedAlliances: ['oneworld'],
      allowedAirlines: ['LA', 'BA', 'AA', 'IB', 'QR', 'JL', 'CX', 'AY', 'QF', 'MH'],
      allianceAccess: 'all-alliance',
      openingHours: 'Daily 05:00–23:00',
