...
export const SKYTEAM_LOUNGES: Readonly<Record<string, StaticLounge[]>> = {
  FRA: [
    {
      ...
      allowedAirlines: ['AF', 'KL', 'DL', 'KE', 'MU', 'CZ', 'AM', 'VN', 'GA'],
  ...
  CDG: [
    ...
    },
    {
      ...
      networks: ['skyteam'],
      allowedAlliances: ['skyteam'],
      allowedAirlines: ['AF', 'KL', 'DL', 'CZ', 'MU', 'AM'],
      allianceAccess: 'all-alliance',
  ...
  AMS: [
    {
      ...
      networks: ['skyteam'],
      allowedAlliances: ['skyteam'],
      allowedAirlines: ['KL', 'AF', 'DL', 'KE', 'MU', 'CZ', 'AM', 'VN'],
      allianceAccess: 'all-alliance',
  ...
  ICN: [
    ...
    },
    {
      ...
      networks: ['skyteam'],
      allowedAlliances: ['skyteam'],
      allowedAirlines: ['KE', 'AF', 'DL', 'MU', 'CZ', 'AM', 'VN', 'GA'],
      allianceAccess: 'all-alliance',
      openingHours: '24 hours',
      amenities: ['Hot buffet', 'Bar', 'Shower rooms', 'WiFi', 'Work area'],
      gateDistances: { '2': 6 },
  ...
  PVG: [
    {
      ...
      networks: ['skyteam'],
      allowedAlliances: ['skyteam'],
      allowedAirlines: ['MU', 'FM', 'AF', 'KL', 'DL', 'KE', 'CZ', 'AM', 'VN'],
      allianceAccess: 'all-alliance',
  ...
  JFK: [
    ...
    },
    {
      ...
      networks: ['skyteam'],
      allowedAlliances: ['skyteam'],
      allowedAirlines: ['DL', 'AF', 'KL', 'KE', 'MU', 'CZ', 'AM', 'VN'],
      allianceAccess: 'all-alliance',
  ...
  SFO: [
    {
      ...
      networks: ['skyteam'],
      allowedAlliances: ['skyteam'],
      allowedAirlines: ['AF', 'KL', 'DL', 'KE', 'MU', 'CZ', 'AM', 'VN'],
      allianceAccess: 'all-alliance',
