...
export const STAR_ALLIANCE_LOUNGES: Readonly<Record<string, StaticLounge[]>> = {
  ...
  FRA: [
    {
      ...
      networks: ['star-alliance'],
      allowedAlliances: ['star-alliance'],
      allowedAirlines: ['LH', 'LX', 'OS', 'SN', 'EW', 'NH', 'UA', 'TG', 'SQ', 'AC', 'TK'],
    ...
    },
    {
      ...
      networks: ['star-alliance'],
      allowedAlliances: ['star-alliance'],
      allowedAirlines: ['LH', 'LX', 'OS', 'SN', 'NH', 'UA', 'TG', 'SQ', 'AC', 'TK'],
      allianceAccess: 'all-alliance',
      openingHours: 'Daily 05:30–22:30',
  ...
  SIN: [
    ...
    },
    {
      ...
      networks: ['star-alliance'],
      allowedAlliances: ['star-alliance'],
      allowedAirlines: ['SQ', 'MI', 'NH', 'LH', 'UA', 'TG', 'AC', 'OZ', 'TK'],
      allianceAccess: 'all-alliance',
      openingHours: '24 hours',
    ...
    },
    {
      ...
      networks: ['star-alliance'],
      allowedAlliances: ['star-alliance'],
      allowedAirlines: ['SQ', 'MI', 'NH', 'LH', 'UA', 'TG', 'AC', 'OZ'],
      allianceAccess: 'all-alliance',
      openingHours: '24 hours',
    ...
    },
    {
      ...
      networks: ['star-alliance'],
      allowedAlliances: ['star-alliance'],
      allowedAirlines: ['SQ', 'MI', 'NH', 'LH', 'UA', 'TG', 'AC'],
      allianceAccess: 'all-alliance',
      openingHours: '24 hours',
      amenities: ['Noodle bar', 'Full buffet', 'Bar', 'Shower suites', 'WiFi'],
    ...
    },
    {
      ...
      networks: ['star-alliance'],
      allowedAlliances: ['star-alliance'],
      allowedAirlines: ['TG', 'NH', 'LH', 'SQ', 'UA', 'AC', 'OZ'],
      allianceAccess: 'all-alliance',
  ...
  ZRH: [
    {
      ...
      networks: ['star-alliance'],
      allowedAlliances: ['star-alliance'],
      allowedAirlines: ['LX', 'LH', 'OS', 'NH', 'UA', 'SQ'],
      allianceAccess: 'all-alliance',
    ...
    },
    {
      ...
      networks: ['star-alliance'],
      allowedAlliances: ['star-alliance'],
      allowedAirlines: ['LX', 'LH', 'OS', 'SN', 'NH', 'UA', 'TG', 'SQ', 'AC', 'TK'],
      allianceAccess: 'all-alliance',
      openingHours: 'Daily 05:30–22:00',
  ...
  IST: [
    {
      ...
      networks: ['star-alliance'],
      allowedAlliances: ['star-alliance'],
      allowedAirlines: ['TK', 'NH', 'LH', 'UA', 'SQ', 'TG', 'AC', 'OZ'],
      allianceAccess: 'all-alliance',
      openingHours: '24 hours',
  ...
  ARN: [
    {
      ...
      networks: ['star-alliance'],
      allowedAlliances: ['star-alliance'],
      allowedAirlines: ['SK', 'WF', 'DY', 'LH', 'NH', 'UA', 'SQ', 'TG', 'AC'],
      allianceAccess: 'all-alliance',
    ...
    },
    {
      ...
      networks: ['star-alliance'],
      allowedAlliances: ['star-alliance'],
      allowedAirlines: ['SK', 'WF', 'NH', 'LH', 'UA', 'SQ'],
      allianceAccess: 'all-alliance',
  ...
  NRT: [
    {
      ...
      networks: ['star-alliance'],
      allowedAlliances: ['star-alliance'],
      allowedAirlines: ['NH', 'LH', 'UA', 'TG', 'SQ', 'AC', 'OZ', 'TK'],
      allianceAccess: 'all-alliance',
  ...
  ICN: [
    ...
    },
    {
      ...
      networks: ['star-alliance'],
      allowedAlliances: ['star-alliance'],
      allowedAirlines: ['OZ', 'LH', 'NH', 'SQ', 'TG', 'UA', 'AC', 'TK'],
      allianceAccess: 'all-alliance',
      openingHours: '24 hours',
      amenities: ['Hot buffet', 'Bar', 'Shower rooms', 'WiFi', 'Work area'],
  ...
  BKK: [
    {
      ...
      networks: ['star-alliance'],
      allowedAlliances: ['star-alliance'],
      allowedAirlines: ['TG', 'NH', 'LH', 'SQ', 'UA', 'AC', 'OZ', 'TK'],
      allianceAccess: 'all-alliance',
      openingHours: 'Daily 05:30–23:00',
  ...
  PEK: [
    ...
    },
    {
      ...
      networks: ['star-alliance'],
      allowedAlliances: ['star-alliance'],
      allowedAirlines: ['CA', 'NH', 'LH', 'UA', 'TG', 'SQ', 'AC', 'OZ'],
      allianceAccess: 'all-alliance',
      openingHours: 'Daily 06:00–23:00',
      amenities: ['Hot buffet', 'Bar', 'Shower rooms', 'WiFi', 'Work area'],
  ...
  JFK: [
    {
      ...
      networks: ['star-alliance'],
      allowedAlliances: ['star-alliance'],
      allowedAirlines: ['UA', 'LH', 'NH', 'SQ', 'TG', 'AC', 'OZ', 'TK'],
      allianceAccess: 'all-alliance',
  ...
  LAX: [
    {
      ...
      networks: ['star-alliance'],
      allowedAlliances: ['star-alliance'],
      allowedAirlines: ['UA', 'LH', 'NH', 'SQ', 'AC', 'OZ', 'TK'],
      allianceAccess: 'all-alliance',
      openingHours: 'Daily 05:00–23:00',
    ...
    },
    {
      ...
      networks: ['star-alliance'],
      allowedAlliances: ['star-alliance'],
      allowedAirlines: ['UA', 'LH', 'NH', 'AC', 'SQ', 'TG', 'OZ'],
      allianceAccess: 'all-alliance',
      openingHours: 'Daily 05:00–23:00',
      amenities: ['Hot buffet', 'Bar', 'Shower rooms', 'WiFi', 'Work area'],
      gateDistances: { 'T7': 8 },
  ...
  YYZ: [
    {
      ...
      networks: ['star-alliance'],
      allowedAlliances: ['star-alliance'],
      allowedAirlines: ['AC', 'LH', 'UA', 'NH', 'SQ', 'TG', 'OZ', 'TK'],
      allianceAccess: 'all-alliance',
      openingHours: 'Daily 05:00–23:00',
  ...
  SFO: [
    ...
    },
    {
      ...
      networks: ['star-alliance'],
      allowedAlliances: ['star-alliance'],
      allowedAirlines: ['UA', 'LH', 'NH', 'AC', 'SQ', 'TG'],
      allianceAccess: 'all-alliance',
      openingHours: 'Daily 05:00–23:00',
      amenities: ['Hot buffet', 'Bar', 'Shower rooms', 'WiFi', 'Work area'],
  ...
  JNB: [
    {
      ...
      networks: ['star-alliance'],
      allowedAlliances: ['star-alliance'],
      allowedAirlines: ['SA', 'LH', 'UA', 'SQ', 'NH', 'AC', 'TK'],
      allianceAccess: 'all-alliance',
  ...
  HKG: [
    {
      ...
      networks: ['star-alliance'],
      allowedAlliances: ['star-alliance'],
      allowedAirlines: ['SQ', 'NH', 'LH', 'UA', 'TG', 'AC', 'OZ', 'TK'],
      allianceAccess: 'all-alliance',
  ...
  DXB: [
    {
      ...
      networks: ['star-alliance'],
      allowedAlliances: ['star-alliance'],
      allowedAirlines: ['LH', 'LX', 'OS', 'SN', 'NH', 'UA', 'TG', 'SQ', 'AC', 'OZ'],
      allianceAccess: 'all-alliance',
  ...
  CDG: [
    {
      ...
      networks: ['star-alliance'],
      allowedAlliances: ['star-alliance'],
      allowedAirlines: ['LH', 'LX', 'OS', 'SN', 'EW', 'NH', 'UA', 'TG', 'SQ', 'AC'],
      allianceAccess: 'all-alliance',
